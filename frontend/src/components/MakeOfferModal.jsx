            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl max-w-md w-full p-6 shadow-2xl">
                ...
                <div className="mb-4">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                        Listed at: <span className="font-semibold text-primary-600 dark:text-primary-400">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    {error && (
                        <div className="bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-900/50 text-red-700 dark:text-red-300 px-4 py-3 rounded">
                            {error}
                        </div>
                    )}
