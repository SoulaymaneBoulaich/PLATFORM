            ...
            <div className="min-h-screen bg-gray-50 dark:bg-slate-900 py-8">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="animate-pulse">
                        <div className="h-96 bg-gray-300 dark:bg-slate-700 rounded-lg mb-8"></div>
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div className="h-64 bg-gray-300 dark:bg-slate-700 rounded"></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    return (
        <PageTransition>
                    ...
                    >
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    ...
                                    {property.area_sqft && (
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <p className="text-2xl font-bold text-gray-900 dark:text-white">{property.area_sqft}</p>
                                    ...
                                    {property.property_type && (
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <p className="text-lg font-bold text-gray-900 dark:text-white capitalize">{property.property_type}</p>
                        ...
                        <motion.div variants={{ hidden: { opacity: 0, x: 20 }, visible: { opacity: 1, x: 0 } }} className="space-y-6">
                            ...
                            {!isOwner && (
                                <div className="card bg-white dark:bg-slate-800 p-6 space-y-3">
                                    <button
                                        ...
                                        className={`w-full btn-secondary flex items-center justify-center gap-2 ${isFavorite ? 'bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-400 border-red-300 dark:border-red-800 hover:bg-red-100 dark:hover:bg-red-900/50' : ''
                                            }`}
                                    >
                                        <svg
                            ...
                            <div className="card bg-white dark:bg-slate-800 p-6">
                                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Property Owner</h3>
                                <div className="flex items-center gap-4 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600 dark:text-gray-400">{property.seller_email}</p>
                                    </div>
                                </div>
            ...
            {showScheduleModal && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                    <div className="bg-white dark:bg-slate-800 rounded-xl max-w-md w-full p-6">
                        <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Schedule a Viewing</h3>
            ...
            {showContactModal && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                    <div className="bg-white dark:bg-slate-800 rounded-xl max-w-md w-full p-6">
                        <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Contact Seller</h3>
