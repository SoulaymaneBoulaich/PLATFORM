            ...
            <div className="min-h-screen bg-gray-50 py-8">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="card bg-white p-6">
                            <div className="flex items-center">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="text-2xl font-bold text-gray-900">{summary?.savedSearches || 0}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="card bg-white p-6">
                            <div className="flex items-center">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="text-2xl font-bold text-gray-900">{summary?.pendingOffers || 0}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <Link to="/properties" className="card bg-white p-6 hover:shadow-lg transition-shadow">
