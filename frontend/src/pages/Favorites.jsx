...
const Favorites = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-purple-50 to-pink-50 dark:from-slate-900 dark:via-slate-900 dark:to-slate-800 pt-20 pb-12">
            {/* Hero Section */}
                ...
                {favorites.length === 0 ? (
                    ...
                    >
                        <div className="card-glass max-w-md mx-auto p-12">
                            <FaHeart className="text-6xl text-gray-300 dark:text-slate-600 mx-auto mb-6" />
                                    ...
                                    <div className="p-5">
                                        <div className="flex items-start justify-between mb-3">
                                            ...
                                            <button
                                                ...
                                                className="p-2 hover:bg-red-50 dark:hover:bg-red-900/40 rounded-full transition-colors group/btn"
