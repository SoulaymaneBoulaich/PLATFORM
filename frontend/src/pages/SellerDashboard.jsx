            ...
            <div className="min-h-screen bg-gray-50 py-8">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="card bg-white p-6">
                            <div className="flex items-center">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="text-2xl font-bold text-gray-900">{summary?.activeProperties || 0}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="card bg-white p-6">
                            <div className="flex items-center">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="text-2xl font-bold text-gray-900">{summary?.soldProperties || 0}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="card bg-white p-6">
                            ...
                            <div className="space-y-4">
                                {summary.topProperties.map(property => (
                                    <div key={property.property_id} className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                                        <img
                                        ...
                                        <div className="text-right">
                                            <p className="text-2xl font-bold text-primary-600">{property.view_count}</p>
                    ...
                    <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                        <Link to="/dashboard" className="card bg-white p-6 hover:shadow-lg transition-shadow">
                            <h3 className="font-semibold text-gray-900 mb-2">Manage Properties</h3>
                            <p className="text-sm text-gray-600">Add, edit, or remove your listings</p>
                        </Link>
                        <Link to="/messages" className="card bg-white p-6 hover:shadow-lg transition-shadow">
                            <h3 className="font-semibold text-gray-900 mb-2">Messages</h3>
                            <p className="text-sm text-gray-600">Chat with potential buyers</p>
                        </Link>
                        <Link to="/dashboard" className="card bg-white p-6 hover:shadow-lg transition-shadow">
